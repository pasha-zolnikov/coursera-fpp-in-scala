...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  else if (left.isEmpty) elem compareRetweets right.mostRetweeted
  else if (right.isEmpty) elem compareRetweets left.mostRetweeted
  else elem compareRetweets left.mostRetweeted compareRetweets right.mostRetweeted
